...
| A provider's rate-limit page | The document that decides whether a workload is possible at all | Free to read | https://developers.openai.com/api/docs/guides/rate-limits | Task t06 — find the limit at your actual tier, not the marketing tier | Each provider's own docs; compare two |
