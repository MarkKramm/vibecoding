...
- **Structured Outputs (OpenAI)** — https://developers.openai.com/api/docs/guides/structured-outputs — one provider's schema-constrained decoding. Read it for what it does and does not guarantee: it constrains shape, not meaning.
